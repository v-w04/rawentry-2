...
function _posicionarRadial(){
  ...
  grid.style.cssText='position:relative;width:800px;height:800px;margin:0 auto;overflow:visible;background:none!important;border:none!important;box-shadow:none!important;padding:0';
  ...
  if(inner)inner.style.cssText='background:none!important;border:none!important;box-shadow:none!important;overflow:visible;padding:0;margin:0;width:800px;height:800px;min-height:0;display:block';
  ...
  function sT(e,t){} function mT(e){} function hT(){}
  var actSub=false,subG=null;

  // Fondo circular
  var bgC=document.createElementNS(NS,'circle');
  bgC.setAttribute('cx','400');bgC.setAttribute('cy','400');bgC.setAttribute('r','186');
  bgC.setAttribute('fill','rgba(10,12,18,0.88)');svg.appendChild(bgC);
  ...
  function makeSVGIcon(iconPath,x,y,size,color){
    ...
    fo.style.overflow='visible';fo.setAttribute('fill',color);fo.setAttribute('color',color);
    fo.innerHTML=iconPath;return fo;
  }

  (function(){
    var g=document.createElementNS(NS,'g');g.style.cursor='pointer';
    var p=document.createElementNS(NS,'path');
    p.setAttribute('d',"M400.00,218.00 A182,182,0,0,1,506.98,252.76 L439.97,344.99 A68,68,0,0,0,400.00,332.00Z");p.setAttribute('fill',"rgba(30,32,38,0.92)");
    p.setAttribute('stroke','rgba(255,255,255,0.06)');p.setAttribute('stroke-width','1.5');
    p.style.transition='fill .15s';g.appendChild(p);
    g.appendChild(makeSVGIcon(`<path d="M12 2C8.5 2 6 4.5 6 7c0 1.5.7 2.8 1.8 3.7L7 14h10l-.8-3.3C17.3 9.8 18 8.5 18 7c0-2.5-2.5-5-6-5zm-2 14v1a2 2 0 004 0v-1H10z" fill="currentColor"/>`,441.3,258.9,36,'#4ADE80'));
    var lb=document.createElementNS(NS,'text');
    lb.setAttribute('x','441.3');lb.setAttribute('y','294.9');
    ...
    g.appendChild(lb);
    g.addEventListener('mouseover',function(e){p.setAttribute('fill',"rgba(55,60,70,0.98)");});
  ...
  (function(){
    var g=document.createElementNS(NS,'g');g.style.cursor='pointer';
    var p=document.createElementNS(NS,'path');
    p.setAttribute('d',"M506.98,252.76 A182,182,0,0,1,573.09,343.76 L464.67,378.99 A68,68,0,0,0,439.97,344.99Z");p.setAttribute('fill',"rgba(30,32,38,0.92)");
    p.setAttribute('stroke','rgba(255,255,255,0.06)');p.setAttribute('stroke-width','1.5');
    p.style.transition='fill .15s';g.appendChild(p);
    g.appendChild(makeSVGIcon(`<path d="M3 21h18v-2H3v2zm0-4h18v-2H3v2zm0-4h18v-2H3v2zm0-4h18V7H3v2zm9-8L2 7h20L12 1z" fill="currentColor"/>`,508.1,307.4,36,'#F59E0B'));
    var lb=document.createElementNS(NS,'text');
    lb.setAttribute('x','508.1');lb.setAttribute('y','343.4');
    lb.setAttribute('text-anchor','middle');lb.setAttribute('dominant-baseline','middle');
    lb.setAttribute('font-size','13');lb.setAttribute('font-weight','600');
    lb.setAttribute('fill','rgba(255,255,255,0.78)');
    lb.setAttribute('font-family','system-ui,-apple-system,sans-serif');
  ...
  (function(){
    var g=document.createElementNS(NS,'g');g.style.cursor='pointer';
    var p=document.createElementNS(NS,'path');
    p.setAttribute('d',"M573.09,343.76 A182,182,0,0,1,573.09,456.24 L464.67,421.01 A68,68,0,0,0,464.67,378.99Z");p.setAttribute('fill',"rgba(30,32,38,0.92)");
    p.setAttribute('stroke','rgba(255,255,255,0.06)');p.setAttribute('stroke-width','1.5');
    p.style.transition='fill .15s';g.appendChild(p);
    g.appendChild(makeSVGIcon(`<path d="M20.57 14.86L22 13.43 20.57 12 17 15.57 8.43 7 12 3.43 10.57 2 9.14 3.43 7.71 2 5.57 4.14 4.14 2.71 2.71 4.14l1.43 1.43L2 7.71l1.43 1.43L2 10.57 3.43 12 7 8.43 15.57 17 12 20.57 13.43 22l1.43-1.43L16.29 22l2.14-2.14 1.43 1.43 1.43-1.43-1.43-1.43L22 16.29l-1.43-1.43z" fill="currentColor"/>`,533.7,386.0,36,'#FB923C'));
    var lb=document.createElementNS(NS,'text');
    lb.setAttribute('x','533.7');lb.setAttribute('y','422.0');
    lb.setAttribute('text-anchor','middle');lb.setAttribute('dominant-baseline','middle');
    lb.setAttribute('font-size','13');lb.setAttribute('font-weight','600');
    lb.setAttribute('fill','rgba(255,255,255,0.78)');
    lb.setAttribute('font-family','system-ui,-apple-system,sans-serif');
  ...
  (function(){
    var g=document.createElementNS(NS,'g');g.style.cursor='pointer';
    var p=document.createElementNS(NS,'path');
    p.setAttribute('d',"M573.09,456.24 A182,182,0,0,1,506.98,547.24 L439.97,455.01 A68,68,0,0,0,464.67,421.01Z");p.setAttribute('fill',"rgba(30,32,38,0.92)");
    p.setAttribute('stroke','rgba(255,255,255,0.06)');p.setAttribute('stroke-width','1.5');
    p.style.transition='fill .15s';g.appendChild(p);
    g.appendChild(makeSVGIcon(`<path d="M18.06 22.99h1.66c.84 0 1.53-.64 1.63-1.46L23 5.05h-5V1h-1.97v4.05h-4.97l.3 2.34c1.71.47 3.31 1.32 4.27 2.26 1.44 1.42 2.43 2.89 2.43 5.29v8.05zM1 21.99V21h15.03v.99c0 .55-.45 1-1.01 1H2.01c-.56 0-1.01-.45-1.01-1zm15.03-7H1v-2h15.03v2zm0-4H1v-2h15.03v2z" fill="currentColor"/>`,508.1,464.6,36,'#4ADE80'));
    var lb=document.createElementNS(NS,'text');
    lb.setAttribute('x','508.1');lb.setAttribute('y','500.6');
    lb.setAttribute('text-anchor','middle');lb.setAttribute('dominant-baseline','middle');
    lb.setAttribute('font-size','13');lb.setAttribute('font-weight','600');
    lb.setAttribute('fill','rgba(255,255,255,0.78)');
    lb.setAttribute('font-family','system-ui,-apple-system,sans-serif');
  ...
  (function(){
    var g=document.createElementNS(NS,'g');g.style.cursor='pointer';
    var p=document.createElementNS(NS,'path');
    p.setAttribute('d',"M506.98,547.24 A182,182,0,0,1,400.00,582.00 L400.00,468.00 A68,68,0,0,0,439.97,455.01Z");p.setAttribute('fill',"rgba(30,32,38,0.92)");
    p.setAttribute('stroke','rgba(255,255,255,0.06)');p.setAttribute('stroke-width','1.5');
    p.style.transition='fill .15s';g.appendChild(p);
    g.appendChild(makeSVGIcon(`<path d="M4 10v7h3v-7H4zm6.5 0v7h3v-7h-3zM2 22h19v-3H2v3zm15-12v7h3v-7h-3zM11.5 1L2 6v2h19V6l-9.5-5z" fill="currentColor"/>`,441.3,513.1,36,'#C4B5FD'));
    var lb=document.createElementNS(NS,'text');
    lb.setAttribute('x','441.3');lb.setAttribute('y','549.1');
    lb.setAttribute('text-anchor','middle');lb.setAttribute('dominant-baseline','middle');
    lb.setAttribute('font-size','13');lb.setAttribute('font-weight','600');
    lb.setAttribute('fill','rgba(255,255,255,0.78)');
    lb.setAttribute('font-family','system-ui,-apple-system,sans-serif');
  ...
  (function(){
    var g=document.createElementNS(NS,'g');g.style.cursor='pointer';
    var p=document.createElementNS(NS,'path');
    p.setAttribute('d',"M400.00,582.00 A182,182,0,0,1,293.02,547.24 L360.03,455.01 A68,68,0,0,0,400.00,468.00Z");p.setAttribute('fill',"rgba(30,32,38,0.92)");
    p.setAttribute('stroke','rgba(255,255,255,0.06)');p.setAttribute('stroke-width','1.5');
    p.style.transition='fill .15s';g.appendChild(p);
    g.appendChild(makeSVGIcon(`<path d="M11.5 2C6.81 2 3 5.81 3 10.5S6.81 19 11.5 19h.5v3c4.86-2.34 8-7 8-11.5C20 5.81 16.19 2 11.5 2zm1 14.5h-2v-2h2v2zm0-4h-2c0-3.25 3-3 3-5 0-1.1-.9-2-2-2s-2 .9-2 2h-2c0-2.21 1.79-4 4-4s4 1.79 4 4c0 2.5-3 2.75-3 5z" fill="currentColor"/>`,358.7,513.1,36,'#F9A8D4'));
    var lb=document.createElementNS(NS,'text');
    lb.setAttribute('x','358.7');lb.setAttribute('y','549.1');
    lb.setAttribute('text-anchor','middle');lb.setAttribute('dominant-baseline','middle');
    lb.setAttribute('font-size','13');lb.setAttribute('font-weight','600');
    lb.setAttribute('fill','rgba(255,255,255,0.78)');
    lb.setAttribute('font-family','system-ui,-apple-system,sans-serif');
  ...
  (function(){
    var g=document.createElementNS(NS,'g');g.style.cursor='pointer';
    var p=document.createElementNS(NS,'path');
    p.setAttribute('d',"M293.02,547.24 A182,182,0,0,1,226.91,456.24 L335.33,421.01 A68,68,0,0,0,360.03,455.01Z");p.setAttribute('fill',"rgba(30,32,38,0.92)");
    p.setAttribute('stroke','rgba(255,255,255,0.06)');p.setAttribute('stroke-width','1.5');
    p.style.transition='fill .15s';g.appendChild(p);
    g.appendChild(makeSVGIcon(`<path d="M16 11c1.66 0 2.99-1.34 2.99-3S17.66 5 16 5c-1.66 0-3 1.34-3 3s1.34 3 3 3zm-8 0c1.66 0 2.99-1.34 2.99-3S9.66 5 8 5C6.34 5 5 6.34 5 8s1.34 3 3 3zm0 2c-2.33 0-7 1.17-7 3.5V19h14v-2.5c0-2.33-4.67-3.5-7-3.5zm8 0c-.29 0-.62.02-.97.05 1.16.84 1.97 1.97 1.97 3.45V19h6v-2.5c0-2.33-4.67-3.5-7-3.5z" fill="currentColor"/>`,291.9,464.6,36,'#93C5FD'));
    var lb=document.createElementNS(NS,'text');
    lb.setAttribute('x','291.9');lb.setAttribute('y','500.6');
    lb.setAttribute('text-anchor','middle');lb.setAttribute('dominant-baseline','middle');
    lb.setAttribute('font-size','13');lb.setAttribute('font-weight','600');
    lb.setAttribute('fill','rgba(255,255,255,0.78)');
    lb.setAttribute('font-family','system-ui,-apple-system,sans-serif');
  ...
  (function(){
    var g=document.createElementNS(NS,'g');g.style.cursor='pointer';
    var p=document.createElementNS(NS,'path');
    p.setAttribute('d',"M226.91,456.24 A182,182,0,0,1,226.91,343.76 L335.33,378.99 A68,68,0,0,0,335.33,421.01Z");p.setAttribute('fill',"rgba(30,32,38,0.92)");
    p.setAttribute('stroke','rgba(255,255,255,0.06)');p.setAttribute('stroke-width','1.5');
    p.style.transition='fill .15s';g.appendChild(p);
    g.appendChild(makeSVGIcon(`<path d="M3 17.25V21h3.75L17.81 9.94l-3.75-3.75L3 17.25zM20.71 7.04c.39-.39.39-1.02 0-1.41l-2.34-2.34c-.39-.39-1.02-.39-1.41 0l-1.83 1.83 3.75 3.75 1.83-1.83z" fill="currentColor"/>`,266.3,386.0,36,'#94A3B8'));
    var lb=document.createElementNS(NS,'text');
    lb.setAttribute('x','266.3');lb.setAttribute('y','422.0');
    lb.setAttribute('text-anchor','middle');lb.setAttribute('dominant-baseline','middle');
    lb.setAttribute('font-size','13');lb.setAttribute('font-weight','600');
    lb.setAttribute('fill','rgba(255,255,255,0.78)');
    lb.setAttribute('font-family','system-ui,-apple-system,sans-serif');
  ...
  (function(){
    var g=document.createElementNS(NS,'g');g.style.cursor='pointer';
    var p=document.createElementNS(NS,'path');
    p.setAttribute('d',"M226.91,343.76 A182,182,0,0,1,293.02,252.76 L360.03,344.99 A68,68,0,0,0,335.33,378.99Z");p.setAttribute('fill',"rgba(30,32,38,0.92)");
    p.setAttribute('stroke','rgba(255,255,255,0.06)');p.setAttribute('stroke-width','1.5');
    p.style.transition='fill .15s';g.appendChild(p);
    g.appendChild(makeSVGIcon(`<path d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z" fill="currentColor"/>`,291.9,307.4,36,'#FCA5A5'));
    var lb=document.createElementNS(NS,'text');
    lb.setAttribute('x','291.9');lb.setAttribute('y','343.4');
    lb.setAttribute('text-anchor','middle');lb.setAttribute('dominant-baseline','middle');
    lb.setAttribute('font-size','13');lb.setAttribute('font-weight','600');
    lb.setAttribute('fill','rgba(255,255,255,0.78)');
    lb.setAttribute('font-family','system-ui,-apple-system,sans-serif');
  ...
  (function(){
    var g=document.createElementNS(NS,'g');g.style.cursor='pointer';
    var p=document.createElementNS(NS,'path');
    p.setAttribute('d',"M293.02,252.76 A182,182,0,0,1,400.00,218.00 L400.00,332.00 A68,68,0,0,0,360.03,344.99Z");p.setAttribute('fill',"rgba(34,211,238,0.12)");
    p.setAttribute('stroke','rgba(255,255,255,0.06)');p.setAttribute('stroke-width','1.5');
    p.style.transition='fill .15s';g.appendChild(p);
    g.appendChild(makeSVGIcon(`<path d="M13.49 5.48c1.1 0 2-.9 2-2s-.9-2-2-2-2 .9-2 2 .9 2 2 2zm-3.6 13.9l1-4.4 2.1 2v6h2v-7.5l-2.1-2 .6-3c1.3 1.5 3.3 2.5 5.5 2.5v-2c-1.9 0-3.5-1-4.3-2.4l-1-1.6c-.4-.6-1-1-1.7-1-.3 0-.5.1-.8.1l-5.2 2.2v4.7h2v-3.4l1.8-.7-1.6 8.1-4.9-1-.4 2 7 1.4z" fill="currentColor"/>`,358.7,258.9,36,'#22D3EE'));
    var lb=document.createElementNS(NS,'text');
    lb.setAttribute('x','358.7');lb.setAttribute('y','294.9');
    lb.setAttribute('text-anchor','middle');lb.setAttribute('dominant-baseline','middle');
    lb.setAttribute('font-size','13');lb.setAttribute('font-weight','600');
    lb.setAttribute('fill','rgba(255,255,255,0.78)');
    lb.setAttribute('font-family','system-ui,-apple-system,sans-serif');
    ...
    g.appendChild(lb);
    g.addEventListener('mouseover',function(e){p.setAttribute('fill',"rgba(34,211,238,0.28)");});
  ...
  (function(){
    ...
    sp2.setAttribute('d',"M155.17,298.59 A265,265,0,0,1,249.90,181.61 L293.52,245.06 A188,188,0,0,0,226.31,328.06Z");sp2.setAttribute('fill','rgba(30,32,38,0.92)');
    ...
    sg.appendChild(makeSVGIcon(`<path d="M18 2H6c-1.1 0-2 .9-2 2v16c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zM6 4h5v8l-2.5-1.5L6 12V4z" fill="currentColor"/>`,222.3,244.1,32,'#EC4899'));
    var sl=document.createElementNS(NS,'text');
    sl.setAttribute('x','222.3');sl.setAttribute('y','276.1');
  ...
  (function(){
    var sg=document.createElementNS(NS,'g');sg.style.cursor='pointer';
    var sp2=document.createElementNS(NS,'path');
    sp2.setAttribute('d',"M249.90,181.61 A265,265,0,0,1,393.06,135.09 L395.08,212.06 A188,188,0,0,0,293.52,245.06Z");sp2.setAttribute('fill','rgba(30,32,38,0.92)');
    sp2.setAttribute('stroke','rgba(255,255,255,0.06)');sp2.setAttribute('stroke-width','1.5');
    sp2.style.transition='fill .15s';sg.appendChild(sp2);
    sg.appendChild(makeSVGIcon(`<path d="M18 4l2 4h-3l-2-4h-2l2 4h-3l-2-4H8l2 4H7L5 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V4h-4z" fill="currentColor"/>`,329.3,170.5,32,'#F59E0B'));
    var sl=document.createElementNS(NS,'text');
    sl.setAttribute('x','329.3');sl.setAttribute('y','202.5');
    sl.setAttribute('text-anchor','middle');sl.setAttribute('dominant-baseline','middle');
    sl.setAttribute('font-size','13');sl.setAttribute('font-weight','600');
    sl.setAttribute('fill','rgba(255,255,255,0.78)');
  ...
  (function(){
    var sg=document.createElementNS(NS,'g');sg.style.cursor='pointer';
    var sp2=document.createElementNS(NS,'path');
    sp2.setAttribute('d',"M393.06,135.09 A265,265,0,0,1,538.46,174.05 L498.23,239.70 A188,188,0,0,0,395.08,212.06Z");sp2.setAttribute('fill','rgba(30,32,38,0.92)');
    sp2.setAttribute('stroke','rgba(255,255,255,0.06)');sp2.setAttribute('stroke-width','1.5');
    sp2.style.transition='fill .15s';sg.appendChild(sp2);
    sg.appendChild(makeSVGIcon(`<path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm-7 3c1.93 0 3.5 1.57 3.5 3.5S13.93 13 12 13s-3.5-1.57-3.5-3.5S10.07 6 12 6zm7 13H5v-.23c0-.62.28-1.2.76-1.58C7.47 15.82 9.64 15 12 15s4.53.82 6.24 2.19c.48.38.76.97.76 1.58V19z" fill="currentColor"/>`,459.2,167.1,32,'#8B5CF6'));
    var sl=document.createElementNS(NS,'text');
    sl.setAttribute('x','459.2');sl.setAttribute('y','199.1');
    sl.setAttribute('text-anchor','middle');sl.setAttribute('dominant-baseline','middle');
    sl.setAttribute('font-size','13');sl.setAttribute('font-weight','600');
    sl.setAttribute('fill','rgba(255,255,255,0.78)');
  ...
  cO.setAttribute('cx','400');cO.setAttribute('cy','400');cO.setAttribute('r','90');
  ...
  cI.setAttribute('cx','400');cI.setAttribute('cy','400');cI.setAttribute('r','70');
  ...
  cTx.setAttribute('x','400');cTx.setAttribute('y','392');cTx.setAttribute('text-anchor','middle');
  ...
  cLb.setAttribute('x','400');cLb.setAttribute('y','432');cLb.setAttribute('text-anchor','middle');
