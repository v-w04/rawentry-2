...
function _posicionarRadial(){
  ...
  grid.style.cssText='position:relative;width:400px;height:400px;margin:0 auto;overflow:visible;background:none!important;border:none!important;box-shadow:none!important';

  // Ocultar todo el wrapper del popup excepto el SVG
  var hdr=document.querySelector('.entrada-selector-hdr');
  if(hdr)hdr.style.display='none';
  var inner=document.querySelector('.entrada-dropdown-inner');
  if(inner){inner.style.cssText='background:none!important;border:none!important;box-shadow:none!important;overflow:visible;padding:0;margin:0;display:block;width:400px;height:400px';}
  var overlay=document.querySelector('.entrada-overlay');
  ...
  (function(){
    ...
    p.setAttribute('fill',"rgba(30,30,35,0.85)");
    ...
    ic.setAttribute('x','241.3');ic.setAttribute('y','62.9');
    ic.setAttribute('text-anchor','middle');ic.setAttribute('dominant-baseline','middle');
    ic.setAttribute('font-size','24');ic.style.pointerEvents='none';
    ic.textContent='🐷';
    var lb=document.createElementNS(NS,'text');
    lb.setAttribute('x','241.3');lb.setAttribute('y','88.9');
    ...
    lb.setAttribute('fill','rgba(255,255,255,0.75)');
    ...
    g.addEventListener('mouseover',function(e){p.setAttribute('fill',"rgba(60,60,70,0.95)");sT(e,'Apartado');});
    g.addEventListener('mousemove',mT);g.addEventListener('mouseout',function(){p.setAttribute('fill',"rgba(30,30,35,0.85)");hT();});
  ...
  (function(){
    ...
    p.style.transition='fill .15s';g.appendChild(p);
    var ic=document.createElementNS(NS,'text');
    ic.setAttribute('x','308.1');ic.setAttribute('y','111.4');
    ic.setAttribute('text-anchor','middle');ic.setAttribute('dominant-baseline','middle');
    ic.setAttribute('font-size','24');ic.style.pointerEvents='none';
    ic.textContent='🏛';
    var lb=document.createElementNS(NS,'text');
    lb.setAttribute('x','308.1');lb.setAttribute('y','137.4');
    lb.setAttribute('text-anchor','middle');lb.setAttribute('dominant-baseline','middle');
    lb.setAttribute('font-size','10');lb.setAttribute('font-weight','600');
    lb.setAttribute('fill','rgba(255,255,255,0.75)');
    lb.setAttribute('font-family','system-ui,-apple-system,sans-serif');
    ...
    g.appendChild(ic);g.appendChild(lb);
    g.addEventListener('mouseover',function(e){p.setAttribute('fill',"rgba(60,60,70,0.95)");sT(e,'Bancos');});
    g.addEventListener('mousemove',mT);g.addEventListener('mouseout',function(){p.setAttribute('fill',"rgba(30,30,35,0.85)");hT();});
  ...
  (function(){
    ...
    p.style.transition='fill .15s';g.appendChild(p);
    var ic=document.createElementNS(NS,'text');
    ic.setAttribute('x','333.7');ic.setAttribute('y','190.0');
    ic.setAttribute('text-anchor','middle');ic.setAttribute('dominant-baseline','middle');
    ic.setAttribute('font-size','24');ic.style.pointerEvents='none';
    ic.textContent='🏋';
    var lb=document.createElementNS(NS,'text');
    lb.setAttribute('x','333.7');lb.setAttribute('y','216.0');
    lb.setAttribute('text-anchor','middle');lb.setAttribute('dominant-baseline','middle');
    lb.setAttribute('font-size','10');lb.setAttribute('font-weight','600');
    lb.setAttribute('fill','rgba(255,255,255,0.75)');
    lb.setAttribute('font-family','system-ui,-apple-system,sans-serif');
    ...
    g.appendChild(ic);g.appendChild(lb);
    g.addEventListener('mouseover',function(e){p.setAttribute('fill',"rgba(60,60,70,0.95)");sT(e,'Entrena');});
    g.addEventListener('mousemove',mT);g.addEventListener('mouseout',function(){p.setAttribute('fill',"rgba(30,30,35,0.85)");hT();});
  ...
  (function(){
    ...
    p.style.transition='fill .15s';g.appendChild(p);
    var ic=document.createElementNS(NS,'text');
    ic.setAttribute('x','308.1');ic.setAttribute('y','268.6');
    ic.setAttribute('text-anchor','middle');ic.setAttribute('dominant-baseline','middle');
    ic.setAttribute('font-size','24');ic.style.pointerEvents='none';
    ic.textContent='🍎';
    var lb=document.createElementNS(NS,'text');
    lb.setAttribute('x','308.1');lb.setAttribute('y','294.6');
    lb.setAttribute('text-anchor','middle');lb.setAttribute('dominant-baseline','middle');
    lb.setAttribute('font-size','10');lb.setAttribute('font-weight','600');
    lb.setAttribute('fill','rgba(255,255,255,0.75)');
    lb.setAttribute('font-family','system-ui,-apple-system,sans-serif');
    ...
    g.appendChild(ic);g.appendChild(lb);
    g.addEventListener('mouseover',function(e){p.setAttribute('fill',"rgba(60,60,70,0.95)");sT(e,'Nutrición');});
    g.addEventListener('mousemove',mT);g.addEventListener('mouseout',function(){p.setAttribute('fill',"rgba(30,30,35,0.85)");hT();});
  ...
  (function(){
    ...
    p.style.transition='fill .15s';g.appendChild(p);
    var ic=document.createElementNS(NS,'text');
    ic.setAttribute('x','241.3');ic.setAttribute('y','317.1');
    ic.setAttribute('text-anchor','middle');ic.setAttribute('dominant-baseline','middle');
    ic.setAttribute('font-size','24');ic.style.pointerEvents='none';
    ic.textContent='🏦';
    var lb=document.createElementNS(NS,'text');
    lb.setAttribute('x','241.3');lb.setAttribute('y','343.1');
    lb.setAttribute('text-anchor','middle');lb.setAttribute('dominant-baseline','middle');
    lb.setAttribute('font-size','10');lb.setAttribute('font-weight','600');
    lb.setAttribute('fill','rgba(255,255,255,0.75)');
    lb.setAttribute('font-family','system-ui,-apple-system,sans-serif');
    ...
    g.appendChild(ic);g.appendChild(lb);
    g.addEventListener('mouseover',function(e){p.setAttribute('fill',"rgba(60,60,70,0.95)");sT(e,'Patrimonio');});
    g.addEventListener('mousemove',mT);g.addEventListener('mouseout',function(){p.setAttribute('fill',"rgba(30,30,35,0.85)");hT();});
  ...
  (function(){
    ...
    p.style.transition='fill .15s';g.appendChild(p);
    var ic=document.createElementNS(NS,'text');
    ic.setAttribute('x','158.7');ic.setAttribute('y','317.1');
    ic.setAttribute('text-anchor','middle');ic.setAttribute('dominant-baseline','middle');
    ic.setAttribute('font-size','24');ic.style.pointerEvents='none';
    ic.textContent='🧠';
    var lb=document.createElementNS(NS,'text');
    lb.setAttribute('x','158.7');lb.setAttribute('y','343.1');
    lb.setAttribute('text-anchor','middle');lb.setAttribute('dominant-baseline','middle');
    lb.setAttribute('font-size','10');lb.setAttribute('font-weight','600');
    lb.setAttribute('fill','rgba(255,255,255,0.75)');
    lb.setAttribute('font-family','system-ui,-apple-system,sans-serif');
    ...
    g.appendChild(ic);g.appendChild(lb);
    g.addEventListener('mouseover',function(e){p.setAttribute('fill',"rgba(60,60,70,0.95)");sT(e,'Pensa');});
    g.addEventListener('mousemove',mT);g.addEventListener('mouseout',function(){p.setAttribute('fill',"rgba(30,30,35,0.85)");hT();});
  ...
  (function(){
    ...
    p.style.transition='fill .15s';g.appendChild(p);
    var ic=document.createElementNS(NS,'text');
    ic.setAttribute('x','91.9');ic.setAttribute('y','268.6');
    ic.setAttribute('text-anchor','middle');ic.setAttribute('dominant-baseline','middle');
    ic.setAttribute('font-size','24');ic.style.pointerEvents='none';
    ic.textContent='👥';
    var lb=document.createElementNS(NS,'text');
    lb.setAttribute('x','91.9');lb.setAttribute('y','294.6');
    lb.setAttribute('text-anchor','middle');lb.setAttribute('dominant-baseline','middle');
    lb.setAttribute('font-size','10');lb.setAttribute('font-weight','600');
    lb.setAttribute('fill','rgba(255,255,255,0.75)');
    lb.setAttribute('font-family','system-ui,-apple-system,sans-serif');
    ...
    g.appendChild(ic);g.appendChild(lb);
    g.addEventListener('mouseover',function(e){p.setAttribute('fill',"rgba(60,60,70,0.95)");sT(e,'Persona');});
    g.addEventListener('mousemove',mT);g.addEventListener('mouseout',function(){p.setAttribute('fill',"rgba(30,30,35,0.85)");hT();});
  ...
  (function(){
    ...
    p.style.transition='fill .15s';g.appendChild(p);
    var ic=document.createElementNS(NS,'text');
    ic.setAttribute('x','66.3');ic.setAttribute('y','190.0');
    ic.setAttribute('text-anchor','middle');ic.setAttribute('dominant-baseline','middle');
    ic.setAttribute('font-size','24');ic.style.pointerEvents='none';
    ic.textContent='✏';
    var lb=document.createElementNS(NS,'text');
    lb.setAttribute('x','66.3');lb.setAttribute('y','216.0');
    lb.setAttribute('text-anchor','middle');lb.setAttribute('dominant-baseline','middle');
    lb.setAttribute('font-size','10');lb.setAttribute('font-weight','600');
    lb.setAttribute('fill','rgba(255,255,255,0.75)');
    lb.setAttribute('font-family','system-ui,-apple-system,sans-serif');
    ...
    g.appendChild(ic);g.appendChild(lb);
    g.addEventListener('mouseover',function(e){p.setAttribute('fill',"rgba(60,60,70,0.95)");sT(e,'Editar');});
    g.addEventListener('mousemove',mT);g.addEventListener('mouseout',function(){p.setAttribute('fill',"rgba(30,30,35,0.85)");hT();});
  ...
  (function(){
    ...
    p.style.transition='fill .15s';g.appendChild(p);
    var ic=document.createElementNS(NS,'text');
    ic.setAttribute('x','91.9');ic.setAttribute('y','111.4');
    ic.setAttribute('text-anchor','middle');ic.setAttribute('dominant-baseline','middle');
    ic.setAttribute('font-size','24');ic.style.pointerEvents='none';
    ic.textContent='💗';
    var lb=document.createElementNS(NS,'text');
    lb.setAttribute('x','91.9');lb.setAttribute('y','137.4');
    lb.setAttribute('text-anchor','middle');lb.setAttribute('dominant-baseline','middle');
    lb.setAttribute('font-size','10');lb.setAttribute('font-weight','600');
    lb.setAttribute('fill','rgba(255,255,255,0.75)');
    lb.setAttribute('font-family','system-ui,-apple-system,sans-serif');
    ...
    g.appendChild(ic);g.appendChild(lb);
    g.addEventListener('mouseover',function(e){p.setAttribute('fill',"rgba(60,60,70,0.95)");sT(e,'Salud');});
    g.addEventListener('mousemove',mT);g.addEventListener('mouseout',function(){p.setAttribute('fill',"rgba(30,30,35,0.85)");hT();});
  ...
  (function(){
    ...
    p.style.transition='fill .15s';g.appendChild(p);
    var ic=document.createElementNS(NS,'text');
    ic.setAttribute('x','158.7');ic.setAttribute('y','62.9');
    ic.setAttribute('text-anchor','middle');ic.setAttribute('dominant-baseline','middle');
    ic.setAttribute('font-size','24');ic.style.pointerEvents='none';
    ic.textContent='⚡';
    var lb=document.createElementNS(NS,'text');
    lb.setAttribute('x','158.7');lb.setAttribute('y','88.9');
    lb.setAttribute('text-anchor','middle');lb.setAttribute('dominant-baseline','middle');
    lb.setAttribute('font-size','10');lb.setAttribute('font-weight','600');
    lb.setAttribute('fill','rgba(255,255,255,0.75)');
    lb.setAttribute('font-family','system-ui,-apple-system,sans-serif');
    ...
    g.appendChild(ic);g.appendChild(lb);
    g.addEventListener('mouseover',function(e){p.setAttribute('fill',"rgba(34,211,238,0.3)");sT(e,'Activity');});
  ...
  (function(){
    ...
    sp2.setAttribute('d',"M-32.818,103.564 A252,252,0,0,1,57.266,-7.680 L94.648,46.713 A186,186,0,0,0,28.158,128.821Z");sp2.setAttribute('fill','rgba(25,35,40,0.9)');
    sp2.setAttribute('stroke','rgba(34,211,238,0.3)');sp2.setAttribute('stroke-width','1.2');
    sp2.style.transition='fill .15s';sg.appendChild(sp2);
    var se=document.createElementNS(NS,'text');
    se.setAttribute('x','28.5');se.setAttribute('y','53.1');
    se.setAttribute('text-anchor','middle');se.setAttribute('dominant-baseline','middle');
    se.setAttribute('font-size','20');se.style.pointerEvents='none';se.textContent='📚';
    var sl=document.createElementNS(NS,'text');
    sl.setAttribute('x','28.5');sl.setAttribute('y','75.1');
    sl.setAttribute('text-anchor','middle');sl.setAttribute('dominant-baseline','middle');
    sl.setAttribute('font-size','10');sl.setAttribute('font-weight','600');
    sl.setAttribute('fill','rgba(34,211,238,0.9)');
    ...
    sg.addEventListener('mouseout', function(){sp2.setAttribute('fill','rgba(25,35,40,0.9)');});
  ...
  (function(){
    var sg=document.createElementNS(NS,'g');sg.style.cursor='pointer';
    var sp2=document.createElementNS(NS,'path');
    sp2.setAttribute('d',"M57.266,-7.680 A252,252,0,0,1,193.403,-51.914 L195.131,14.064 A186,186,0,0,0,94.648,46.713Z");sp2.setAttribute('fill','rgba(25,35,40,0.9)');
    sp2.setAttribute('stroke','rgba(34,211,238,0.3)');sp2.setAttribute('stroke-width','1.2');
    sp2.style.transition='fill .15s';sg.appendChild(sp2);
    var se=document.createElementNS(NS,'text');
    se.setAttribute('x','131.8');se.setAttribute('y','-17.9');
    se.setAttribute('text-anchor','middle');se.setAttribute('dominant-baseline','middle');
    se.setAttribute('font-size','20');se.style.pointerEvents='none';se.textContent='🎬';
    var sl=document.createElementNS(NS,'text');
    sl.setAttribute('x','131.8');sl.setAttribute('y','4.1');
    sl.setAttribute('text-anchor','middle');sl.setAttribute('dominant-baseline','middle');
    sl.setAttribute('font-size','10');sl.setAttribute('font-weight','600');
    sl.setAttribute('fill','rgba(34,211,238,0.9)');
  ...
  (function(){
    var sg=document.createElementNS(NS,'g');sg.style.cursor='pointer';
    var sp2=document.createElementNS(NS,'path');
    sp2.setAttribute('d',"M193.403,-51.914 A252,252,0,0,1,331.670,-14.865 L297.185,41.409 A186,186,0,0,0,195.131,14.064Z");sp2.setAttribute('fill','rgba(25,35,40,0.9)');
    sp2.setAttribute('stroke','rgba(34,211,238,0.3)');sp2.setAttribute('stroke-width','1.2');
    sp2.style.transition='fill .15s';sg.appendChild(sp2);
    var se=document.createElementNS(NS,'text');
    se.setAttribute('x','257.1');se.setAttribute('y','-21.1');
    se.setAttribute('text-anchor','middle');se.setAttribute('dominant-baseline','middle');
    se.setAttribute('font-size','20');se.style.pointerEvents='none';se.textContent='📌';
    var sl=document.createElementNS(NS,'text');
    sl.setAttribute('x','257.1');sl.setAttribute('y','0.9');
    sl.setAttribute('text-anchor','middle');sl.setAttribute('dominant-baseline','middle');
    sl.setAttribute('font-size','10');sl.setAttribute('font-weight','600');
    sl.setAttribute('fill','rgba(34,211,238,0.9)');
  ...
  cO.setAttribute('fill','rgba(99,102,241,0.22)');cO.setAttribute('stroke','rgba(99,102,241,0.55)');cO.setAttribute('stroke-width','2');
  ...
  cTx.setAttribute('x','200');cTx.setAttribute('y','197');cTx.setAttribute('text-anchor','middle');
  ...
  cLb.setAttribute('x','200');cLb.setAttribute('y','220');cLb.setAttribute('text-anchor','middle');
  cLb.setAttribute('dominant-baseline','middle');cLb.setAttribute('font-size','11');
